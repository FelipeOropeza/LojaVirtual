...
CREATE USER 'Felipe'@'localhost' IDENTIFIED WITH mysql_native_password BY 'kiraFE22022006';
GRANT ALL PRIVILEGES ON db_LojaVirtual. * TO 'Felipe'@'localhost' WITH GRANT OPTION;
...
select nm_livro, vl_preco, ds_capa from vm_livro;
select nm_livro, vl_preco, ds_capa from vm_livro where sg_lancamento = 'S';
select nm_livro, vl_preco, ds_capa from vm_livro where ds_categoria = 'Design';
...
values(default, 'Orlindo Omiya', 'orlindo@gmail.com', 'omiya2', 1, 'Rua Adamastor, 58',
       'Santo', '05252-020');
       
insert into tbl_usuario
values(default, 'Janailson Matias', 'matias@gmail.com', 'janass', 0, 'Rua Jaraguá, 128',
       'São Paulo', '08881-040');
       
insert into tbl_usuario
values(default, 'Olidio Junior', 'olidio@hotmail.com', 'etec20', 0, 'Rua Pompeia, 400',
       'São Paulo', '06585-140');
